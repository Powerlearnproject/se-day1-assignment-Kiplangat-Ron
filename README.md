[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=15574854&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
i.	Developing applications, programs and systems using programming languages and frameworks.
ii.	Maintaining and updating software to keep it functional.
iii.	Collaborating with other team members to ensure best practices when developing software.
iv.	Report to the project manager about the progress of the software development.
...
Roles and Responsibilities;
i.	Test planning – involves activities of defining the objectives of testing and the approach for meeting test objectives.
ii.	Test Strategy – Create a test strategy based on project requirements and schedules. Early testing to eliminate defects at an early stage reduces the bug fixing cost and time.
iii.	Executing tests with appropriate techniques (manually or by using test execution tools) and documenting testing failures.
iv.	Analyze the defects and identify the root cause, troubleshoot defects, such that it does not affect the product quality.
v.	Report defects to software developers by recording software defects with a bug-tracking system. (E.g. Bugzilla, mantis, QA Touch, etc.)
vi.	Inform the test progress against a schedule of the quality management.
vii.	Conduct different test procedures, report issues, and follow up on the status of the issues and collaborate with the software testing team to assess or diagnose problems and suggest possible solutions.
viii.	Monitor and analyze the performance using tools for efficient and problem-free operations.
ix.	Uncover vulnerabilities in the system and determine that its data and resources are protected from intruders.
x.	Provides a test summary report that reflects the software under the test’s top-notch quality.
xi.	Manage the entire testing activity with different test management tools. (e.g. QA Touch)
...
viii.	Liaising for changes and negotiations with relevant stakeholders
ix.	Ensuring software quality standards are met and requirements are submitted within budget and on time
x.	Closing the project and ensuring proper documentation
...
A version control system (VCS) tracks every alteration to a file or set of files, enabling developers to journey back to earlier versions and 
collaborate seamlessly. Centralized version control systems (CVCS) streamline this process by housing all file versions on a single server.
Developers borrow a file to tweak, then return it with updates, all neatly stored and cataloged by the server. This method shines in its simplicity,offering a straightforward path for managing changes. On the other hand, DVCS doesn't just centralize files; it democratizes them. Every developer holds the entire project history locally, empowering offline work and facilitating a tapestry of branching and merging strategies. This flexibility is a boon for dynamic teams aiming to weave together multiple project 
threads without tangling them.
Whether centralized or distributed, version control is the cornerstone of efficient, cohesive software development. 
